...
class RavePrompt:
    ...
    def vert(text, **kwargs):
        ...
        log_message = f"{Colors.GRAY}{_get_time()}{Colors.END} {Colors.GRAY}[{Colors.END} {Colors.PURPLE}{text}{Colors.END} {Colors.GRAY}]{Colors.END}"
        ...
        for index, (key, value) in enumerate(kwargs.items()):
            ...
            line = f"{prefix} {key} {Colors.GRAY}:{Colors.END} {Colors.PURPLE}{value}{Colors.END}"
...
''', start_color = Colors.GRAD_BEGIN , end_color = Colors.GRAD_END)
    ...
    def log(content : str):
        ...
        print(f'{Colors.GRAY}[{Colors.END}{Colors.PURPLE}{dt}{Colors.END}{Colors.GRAY}]{Colors.END} {content}')



    @staticmethod

    def print_rave(content : str):

        print(f'{Colors.GRAY}[{Colors.END}{Colors.PURPLE}RAVE{Colors.END}{Colors.GRAY}]{Colors.END} {content}')
    ...
    def ask_advanced(question : str , regexPattern : re.Pattern):
        ...
        if found:
            ...
            RavePrompt.print_imp(f'Invalid {Colors.PURPLE}{question}{Colors.END}.')
    ...
    def print_prefix(prefix : str , content : str , nl = False):
        if not nl:
            print(f'{Colors.GRAY}[{Colors.END}{Colors.PURPLE}{prefix}{Colors.END}{Colors.GRAY}]{Colors.END} {content}')
        else:
            print(f'\n{Colors.GRAY}[{Colors.END}{Colors.PURPLE}{prefix}{Colors.END}{Colors.GRAY}]{Colors.END} {content}')
    ...
    def print_imp(content : str):
        ...
        print(f'{Colors.GRAY}({Colors.END}{Colors.PURPLE}!!{Colors.END}{Colors.GRAY}){Colors.END} {content}')
    ...
    def ask(question : str , strict = True):
        try:
            answer = input(f'{Colors.GRAY}({Colors.END}{Colors.PURPLE}?{Colors.END}{Colors.GRAY}){Colors.END} {question} {Colors.GRAY}»{Colors.END} ')
    ...
    def weeb_print(content : str):
        ...
        print(f'{Colors.GRAY}({Colors.END}{Colors.PURPLE}キッド{Colors.END}{Colors.GRAY}){Colors.END} {content}')
